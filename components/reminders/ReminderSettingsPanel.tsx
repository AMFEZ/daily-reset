...
} from "@/components/reminders/PushNotificationPanel";
  ...
  return (
    <section className="border border-[#242424] bg-[#050505]">
      ...
      <div className="p-3">
        ...
        <p className="terminal-muted mt-4 border-t border-[#242424] pt-3 text-xs">
          &gt;{" "}
          {deviceTimezone}
        </p>
      </div>
